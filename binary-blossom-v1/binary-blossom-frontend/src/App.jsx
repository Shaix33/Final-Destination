...
export default function App() {
  ...
  // Mock forecast (replace with API data later)
  const forecast = [
  ...
  const crops = [
    {
      name: "Maize",
      instructions: "Plant in well-drained soil with full sunlight. Water regularly.",
      icon: <Agriculture fontSize="large" />,
    },
    {
      name: "Wheat",
      instructions: "Sow in cool seasons. Needs moderate watering and fertile soil.",
      icon: <WbSunny fontSize="large" />,
    },
    {
      name: "Rice",
      instructions: "Requires wet soil conditions. Ideal for paddy fields.",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography
          variant="h5"
          style={{ marginTop: "2rem", marginBottom: "1rem", color: themeColors.text }}
        >
          5-Day Forecast
        </Typography>
